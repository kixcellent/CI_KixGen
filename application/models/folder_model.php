	...
	function check_permissions($folder) {
		...
		if(is_dir($folder)) {
			...
			if($dir_writeable == true) {
				...
				$dir_message = "The output directory is writable, have fun using CI_KixGen";
    		...
    		$dir_message = "The 'output' directory doesn't exists, please create in the root directory of CI_KixGen 2.0 it and make it writable.";
    		$message_id = "error-message";
            $dir_writeable = false;
