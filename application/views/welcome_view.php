...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>CI_KixGen <?php echo $app_version; ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="This is CI_KixGen!!!">
    <meta name="author" content="KiXcellent">
    ...
    <link href="repo/generator/css/kixgen.css" rel="stylesheet">
...
<body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <a class="brand" href="./index.html">CI_KixGen <span><?php echo $app_version; ?><?php echo $app_codename; ?></span></a> 
	            ...
	            <div id="generate_wrapper"><!-- hidden by default -->
                    ...
                    <?php endforeach; ?>
	        			...
	        			<div id="template_desc">
	        				<div class="alert alert-info"><?php foreach( $code_templates as $ct ){ if( $ct['directory'] == 'kixgen_core' ) echo $ct['manifest']['description']; } ?></div>
	        			</div>
    ...
    <!-- Footer -->
    <footer class="footer">
      <p>©2013-<?php echo date('Y'); ?> - KiXcellent, All rights reserved. This application is powered by CodeIgniter.</p>
      <p>This generator GUI is built with <a href="https://github.com/twitter/bootstrap/">Twitter Bootstrap 3</a>, licensed under <a href="http://www.apache.org/licenses/LICENSE-2.0/">Apache License v2.0</a>.</p>
    </footer>
  ...
  <!-- and the winner is -->
  <script src="repo/generator/js/kixgen.js"></script>
